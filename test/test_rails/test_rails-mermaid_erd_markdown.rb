...
class MermaidErdMarkdownTest < Minitest::Test
  ...
  def test_index_markdown
    ...
    result = MermaidErdMarkdown.index_markdown(files)
  ...
  def test_model_markdown
    ...
    result = MermaidErdMarkdown.model_markdown(source)
  ...
  def test_mermaid_markdown
    ...
    result = MermaidErdMarkdown.mermaid_markdown(stubbed_model_data)
  ...
  def test_split_output
    ...
    result = MermaidErdMarkdown.split_output(stubbed_model_data)
